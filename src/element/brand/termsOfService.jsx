                        ...
                        <div className="pop-max-contents">
                            <div className="terms-box">
                                ...
                                <div className="pop-inner-contents">
                                    ...
                                    <span className="txt-13 m-b-10">
                                        이용자의 이메일 주소와 휴대전화번호는 스마트비즈(주)의 운영 기간동안 보유, 이용되며,
                                        이용자가 스마트비즈(주)에서 제공하는 부가 서비스 및 맞춤식 서비스를 거부하는 의사를밝힐 경우 지체 없이 파기합니다.
                                    </span>
                                    <span className="txt-13">
                                        * 이용자는 스마트비즈(주)가 제공하는 서비스의 수신 관련 동의를 자유롭게 거부하실 수 있습니다.<br/> 
                                        하지만 동의를 거부하는 경우 스마트비즈(주)의 이용자 맞춤형 서비스에 관한 정보와 부가서비스 정보를 제공받으실 수 없습니다.<br/> <br/> 
                                        따라서 스마트비즈(주)가 제공하는 이용자 맞춤형 서비스를 이용하시길 원하신다면,<br/>
                                        본 개인정보 수집, 이용 및 이벤트정보 수신에 동의하여 주시기 바랍니다.
                                    </span>
                                </div>
                            </div>
                        </div>
