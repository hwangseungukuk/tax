        ...
        <section class="pop-section">
            <div class="max-container">
                ...
                <div class="pop-section-contents">
                    <span class="pop-title"> 개인정보처리방침 </span>
                    <div class="pop-max-contents">
                        <div class="terms-box">
                            <div class="pop-inner-header">
                                <span class="pop-inner-header-title">개인정보처리방침의목적 </span>
                                <span class="txt-13">
                            ...
                            <div class="pop-inner-contents">
                                <div class="m-b-30">
                                    
                                    <span class="txt-14 m-b-7">
                                        1. 회사의 노력
                                    </span>
                                    
                                    <span class="txt-13 m-b-5">
                            ...
                            <span class="txt-13 m-b-5">○ 수집 방법</span> 
                            <span class="txt-13 m-b-7">회사는 다음과 같은 방법을 통해 개인정보를 수집합니다.</span>
                            <span class="txt-13 m-b-5">ㆍ 회원가입 및 서비스 이용 과정에서 이용자가 개인정보 수집에 대해 동의를 하고 직접 정보를 입력하는 경우</span>
                            <span class="txt-13 m-b-5">ㆍ 회원가입 및 서비스 이용을 위하여 이용자가 회사에게 직접 개인정보 조회 등에 대한 권한을 위임하면 회사가 직접 국세청, 고용보험, 은행 및 카드사 인터넷뱅킹 사이트 등을 조회하는 경우</span>
                            <span class="txt-13 m-b-10">ㆍ 제휴 서비스 또는 단체로부터 개인정보를 제공받은 경우</span>
                            <span class="txt-13 m-b-5">○ 보관 기간</span>
                            <span class="txt-13 m-b-7">회사는 이용자의 서비스 마지막 이용일 또는 회원 탈퇴 후 1년이 되는 시점 또는 법령에 따른 보존 기간이 경과되는 시점에 보관하던 해당 이용자의 모든 개인정보를 삭제합니다.</span>
                            <span class="txt-13 m-b-7"> 법령에 따라 일정 기간 보관해야 하는 개인정보 및 해당 법령은 아래 표와 같습니다.</span>
